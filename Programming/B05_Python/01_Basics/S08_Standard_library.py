...
#T# the globals function returns a dictionary of global names paired to their values
    dict1 = globals() # {'__name__': '__main__', '__doc__': None, '__package__': None, '__loader__': <_frozen_importlib_external.SourceFileLoader object at 0x7f77256c8be0>, '__spec__': None, '__annotations__': {}, '__builtins__': <module 'builtins' (built-in)>, '__file__': 'S07_Standard_library.py', '__cached__': None, 'str1': '<map object at 0x7f77256204f0>', 'list1': ['1', '2', 'elem'], 'map1': <map object at 0x7f77256204f0>, 'list2': ['elem'], 'filter1': <filter object at 0x7f7725620e50>, 'func1': <function func1 at 0x7f77256b91f0>}
