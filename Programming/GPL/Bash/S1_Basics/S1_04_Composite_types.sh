...
#T# inside format_string1, escaped characters that begin with a backslash \ are interpreted (see S1_02_Data_types.sh), and also are format specifiers that begin with a percent sign %, these format specifiers dictate the format that arg1, arg2, argN will have
