...
#T# there is a third syntax to declare a function, it's without braces or parentheses, because the body of a function can consist of control flow statements (see S1_05_Control_flow.sh)
...
#     statements1
# }
#T# var1 can be used inside func1 in statements1, and the value of var1 won't become part of the executing shell, -o1 is a flag passed to the local command, the flags accepted by the local command are the same as those of the declare command (see S1_02_Data_types.sh)
