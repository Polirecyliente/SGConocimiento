...
#T#     horizontal tab \t
#T#     vertical tab \v
#T#     unicode character \uNNNN where NNNN is a 16 bit hex number
...
#T# type casting can be done with functions named with the wanted type, e.g. str(var1) to cast var1 as a string

#T# cast from int to int base 10
# int(int1)
#T# this returns int1 in base 10
int1 = int(0o12) # 0o12 is 10
...
# complex(realN,imN)
#T# realN is the real component and imN is the imaginary component
