...
#T# the add_argument functions adds command line arguments that the program will recognize
# parser1.add_argument("arg_name1", help = "help_string1", choices = list1, type = type1, action = "action1", default = val1)
...
#     if "action1" is "store_true" then "arg_name1" is a boolean flag, which becomes True with the presence of "arg_name1", and False with it's absence
#     if "action1" is "count" then count the occurrences of "arg_name1", e.g. -vvv the count is 3, or -flag1 -flag1 here the count is 2
...
#T# an optional argument can have a short and a large version
...
#T# access the elements in a Namespace object with the dot notation, as each argument name becomes an attribute of the Namespace object
