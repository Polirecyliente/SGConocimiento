...
#T# python3 is the Python executable, -m pdb script1.py runs pdb to debug script1.py (see S1_14_Interpreter.py), this automatically enters post-mortem if script1 crashes
...
# 1   breakpoint   keep yes   at /path/to/S1_13_Debugging.py:20
# 2   breakpoint   keep yes   at /path/to/S1_13_Debugging.py:35
...
output_var1 # (Pdb) break S1_13_Debugging:20 # Breakpoint 1 at /path/to/S1_13_Debugging.py:20
...
output_var1 # (Pdb) break S1_13_Debugging.func1, var2 < 10 # Breakpoint 2 at /path/to/S1_13_Debugging.py:35

# SYNTAX disable int1
#T# the disable command disables the breakpoint numbered with the number int1
output_var1 # (Pdb) disable 1 # Disabled breakpoint 1 at /path/to/S1_13_Debugging.py:20

# SYNTAX enable int1
#T# the enable command enables the breakpoint numbered with the number int1
output_var1 # (Pdb) enable 1 # Enabled breakpoint 1 at /path/to/S1_13_Debugging.py:20

# SYNTAX clear int1
#T# the clear command completely deletes a breakpoint
output_var1 # (Pdb) clear 1 # Deleted breakpoint 1 at /path/to/S1_13_Debugging.py:20

# SYNTAX where
#T# the where command prints the stack_frame trace
output_var1 # (Pdb) where
#T# the former prints
#  /path/to/S1_13_Debugging.py(46)<module>()
#-> func2()
#  /path/to/S1_13_Debugging.py(42)func2()
#-> func1(var1[0], var1[2])
#> /path/to/S1_13_Debugging.py(40)func1()->8
#-> return num3
