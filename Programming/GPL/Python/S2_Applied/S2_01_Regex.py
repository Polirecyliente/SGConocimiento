...
#T# to match a particular unicode char, use either \uHex1, the unicode char itself, or \N{name1}, Hex1 is the hexadecimal number of the unicode char being matched, name1 is the char's name in the Unicode standard
...
#T# unicode blocks are matched with \p{block1}, the possible values of block1 are the following: InArmenian, InBasic_Latin, InCombining_Diacritical_Marks, InCyrillic, InCyrillic_Supplement, InGreek_and_Coptic, InIPA_Extensions, InLatin-1_Supplement, InLatin_Extended-A, InLatin_Extended-B, InSpacing_Modifier_Letters, 
...
#T# use the regular unicode modifier with the regex.U constant as valur for the flags kwarg, this makes characters like \w, \s, \d, and similar, to match unicode chars, this is the default behavior
