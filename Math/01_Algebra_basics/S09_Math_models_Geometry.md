...
[Triangle angles sum image code](Programs/S09/01_Triangle_angles_sum_image.py)
![Triangle angles sum image](Images/S09/01_Triangle_angles_sum.png)
*Triangle angles sum*
...
[Pythagorean theorem image code](Programs/S09/02_Pythagorean_theorem_image.py)
![Pythagorean theorem image](Images/S09/02_Pythagorean_theorem.png)
*Pythagorean theorem*
...
[Trapezoid area image code](Programs/S09/03_Trapezoid_area_image.py)
![Trapezoid area image](Images/S09/03_Trapezoid_area.png)
*Trapezoid area*
...
![One third volume image](Images/S09/04_One_third_volume.png)
*One third volume*
