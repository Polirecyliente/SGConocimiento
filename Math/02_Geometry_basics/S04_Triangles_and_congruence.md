...
[Interior angles of a polygon image code](Programs/S04/01_Interior_angles_of_a_polygon_image.py)
![Interior angles of a polygon image](Images/S04/01_Interior_angles_of_a_polygon.png)
...
[Triangle interior angles sum image code](Programs/S04/02_Triangle_interior_angles_sum_image.py)
![Triangle interior angles sum image](Images/S04/02_Triangle_interior_angles_sum.png)
...
[Exterior angles of a polygon image code](Programs/S04/03_Exterior_angles_of_a_polygon_image.py)
![Exterior angles of a polygon image](Images/S04/03_Exterior_angles_of_a_polygon.png)
...
[Triangle exterior angle sum theorem image code](Programs/S04/04_Triangle_exterior_angle_sum_theorem_image.py)
![Triangle exterior angle sum theorem image](Images/S04/04_Triangle_exterior_angle_sum_theorem.png)
...
[Remote interior angles image code](Programs/S04/05_Remote_interior_angles_image.py)
![Remote interior angles image](Images/S04/05_Remote_interior_angles.png)
...
[Congruent triangles images code](Programs/S04/06_Congruent_triangles_image.py)
![Congruent triangles image](Images/S04/06_Congruent_triangles.png)
*Congruent triangles*
...
[AAS triangle congruence theorem image code](Programs/S04/07_AAS_triangle_congruence_theorem_image.py)
![AAS triangle congruence theorem image](Images/S04/07_AAS_triangle_congruence_theorem.png)
...
[Isosceles triangle parts image code](Programs/S04/08_Isosceles_triangle_parts_image.py)
![Isosceles triangle parts image](Images/S04/08_Isosceles_triangle_parts.png)
...
[Base angles theorem image code](Programs/S04/09_Base_angles_theorem_image.py)
![Base angles theorem image](Images/S04/09_Base_angles_theorem.png)
*Base angles theorem*
