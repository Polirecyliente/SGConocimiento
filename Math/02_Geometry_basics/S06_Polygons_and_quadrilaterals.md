...
[Polygon interior angles sum theorem image code](Programs/S06/01_Polygon_interior_angles_sum_theorem_image.py)
![Polygon interior angles sum theorem image](Images/S06/01_Polygon_interior_angles_sum_theorem.png)
...
[Angle in an equiangular polygon formula code](Programs/S06/02_Angle_in_an_equiangular_polygon_formula.py)
...
[Regular polygon image code](Programs/S06/03_Regular_polygon_image.py)
![Regular polygon image](Images/S06/03_Regular_polygon.png)
*Regular polygon*
...
[Parallelogram image code](Programs/S06/04_Parallelogram_image.py)
![Parallelogram image](Images/S06/04_Parallelogram.png)
*Parallelogram*
...
[Opposite sides of a parallelogram theorem image code](Programs/S06/05_Opposite_sides_of_a_parallelogram_theorem_image.py)
![Opposite sides of a parallelogram theorem image](Images/S06/05_Opposite_sides_of_a_parallelogram_theorem.png)
...
[Consecutive angles of a parallelogram theorem image code](Programs/S06/06_Consecutive_angles_of_a_parallelogram_theorem_image.py)
![Consecutive angles of a parallelogram theorem image](Images/S06/06_Consecutive_angles_of_a_parallelogram_theorem.png)
...
[Diagonals of a parallelogram theorem image code](Programs/S06/07_Diagonals_of_a_parallelogram_theorem_image.py)
![Diagonals of a parallelogram theorem image](Images/S06/07_Diagonals_of_a_parallelogram_theorem.png)
...
[Algebraic determination that a quadrilateral is a parallelogram code](Programs/S06/08_Algebraic_determination_that_a_quadrilateral_is_a_parallelogram.py)
...
[Rectangle image code](Programs/S06/09_Rectangle_image.py)
![Rectangle image](Images/S06/09_Rectangle.png)
*Rectangle*

(Rombo)
**Rhombus**: a parallelogram in which all its four sides are congruent.
[Rhombus image code](Programs/S06/10_Rhombus_image.py)
![Rhombus image](Images/S06/10_Rhombus.png)
*Rhombus*
...
[Square image code](Programs/S06/11_Square_image.py)
![Square image](Images/S06/11_Square.png)
*Square*

(Teorema de las diagonales de un rectángulo)
**Diagonals of a rectangle theorem**: in a rectangle, the diagonals are congruent.
[Diagonals of a rectangle theorem image code](Programs/S06/12_Diagonals_of_a_rectangle_theorem_image.py)
![Diagonals of a rectangle theorem image](Images/S06/12_Diagonals_of_a_rectangle_theorem.png)
...
[Perpendicular diagonals of a rhombus theorem image code](Programs/S06/13_Perpendicular_diagonals_of_a_rhombus_theorem_image.py)
![Perpendicular diagonals of a rhombus theorem image](Images/S06/13_Perpendicular_diagonals_of_a_rhombus_theorem.png)
...
[Trapezoid image code](Programs/S06/14_Trapezoid_image.py)
![Trapezoid image](Images/S06/14_Trapezoid.png)
*Trapezoid*

(Trapecio isósceles)
**Isosceles trapezoid**: a trapezoid with its two non-parallel sides congruent.
[Isosceles trapezoid image code](Programs/S06/15_Isosceles_trapezoid_image.py)
![Isosceles trapezoid image](Images/S06/15_Isosceles_trapezoid.png)
*Isosceles trapezoid*
...
[Bases angles of an isosceles trapezoid theorem image code](Programs/S06/16_Bases_angles_of_an_isosceles_trapezoid_theorem_image.py)
![Bases angles of an isosceles trapezoid theorem image](Images/S06/16_Bases_angles_of_an_isosceles_trapezoid_theorem.png)
...
[Converse of the bases angles of an isosceles trapezoid theorem image code](Programs/S06/17_Converse_of_the_bases_angles_of_an_isosceles_trapezoid_theorem_image.py)
![Converse of the bases angles of an isosceles trapezoid theorem image](Images/S06/17_Converse_of_the_bases_angles_of_an_isosceles_trapezoid_theorem.png)
...
[Diagonals of an isosceles trapezoid theorem image code](Programs/S06/18_Diagonals_of_an_isosceles_trapezoid_theorem_image.py)
![Diagonals of an isosceles trapezoid theorem image](Images/S06/18_Diagonals_of_an_isosceles_trapezoid_theorem.png)
...
[Converse of the diagonals of an isosceles trapezoid theorem image code](Programs/S06/19_Converse_of_the_diagonals_of_an_isosceles_trapezoid_theorem_image.py)
![Converse of the diagonals of an isosceles trapezoid theorem image](Images/S06/19_Converse_of_the_diagonals_of_an_isosceles_trapezoid_theorem.png)
...
[Midsegment of a trapezoid image code](Programs/S06/20_Midsegment_of_a_trapezoid_image.py)
![Midsegment of a trapezoid image](Images/S06/20_Midsegment_of_a_trapezoid.png)
...
[Midsegment of a trapezoid theorem image code](Programs/S06/21_Midsegment_of_a_trapezoid_theorem_image.py)
![Midsegment of a trapezoid theorem image](Images/S06/21_Midsegment_of_a_trapezoid_theorem.png)
...
[Kite image code](Programs/S06/22_Kite_image.py)
![Kite image](Images/S06/22_Kite.png)
*Kite*

(Deltoide cóncavo | Punta de flecha)
**Dart**: a concave kite.
[Dart image code](Programs/S06/23_Dart_image.py)
![Dart image](Images/S06/23_Dart.png)
*Dart*
...
[Kite parts image code](Programs/S06/24_Kite_parts.py)
![Kite parts image](Images/S06/24_Kite_parts.png)
*Kite parts*
...
[Non-vertex angles of a kite theorem image code](Programs/S06/25_Non-vertex_angles_of_a_kite_theorem_image.py)
![Non-vertex angles of a kite theorem image](Images/S06/25_Non-vertex_angles_of_a_kite_theorem.png)
...
[Diagonals of a kite theorem image code](Programs/S06/26_Diagonals_of_a_kite_theorem_image.py)
![Diagonals of a kite theorem image](Images/S06/26_Diagonals_of_a_kite_theorem.png)
