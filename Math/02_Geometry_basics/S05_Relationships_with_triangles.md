...
[Midsegment of a triangle image code](Programs/S05/01_Midsegment_of_a_triangle_image.py)
![Midsegment of a triangle image](Images/S05/01_Midsegment_of_a_triangle.png)
*Midsegment of a triangle*

The segment $\overline{DE}$ is a midsegment of the triangle $\triangle ABC$.

Every triangle has three midsegments.
[Three midsegments of a triangle image code](Programs/S05/02_Three_midsegments_of_a_triangle_image.py)
![Three midsegments of a triangle image](Images/S05/02_Three_midsegments_of_a_triangle.png)
...
[Perpendicular bisector theorem image code](Programs/S05/03_Perpendicular_bisector_theorem_image.py)
![Perpendicular bisector theorem image](Images/S05/03_Perpendicular_bisector_theorem.png)
...
[Point of concurrency image code](Programs/S05/04_Point_of_concurrency_image.py)
![Point of concurrency image](Images/S05/04_Point_of_concurrency.png)
...
[Circumcenter of a triangle image code](Programs/S05/05_Circumcenter_of_a_triangle_image.py)
![Circumcenter of a triangle image](Images/S05/05_Circumcenter_of_a_triangle.png)
...
[Equidistance in an angle bisector theorem image code](Programs/S05/06_Equidistance_in_an_angle_bisector_theorem_image.py)
![Equidistance in an angle bisector theorem image](Images/S05/06_Equidistance_in_an_angle_bisector_theorem.png)
...
[Incenter of a triangle image code](Programs/S05/07_Incenter_of_a_triangle_image.py)
![Incenter of a triangle image](Images/S05/07_Incenter_of_a_triangle.png)
...
[Median of a triangle image code](Programs/S05/08_Median_of_a_triangle_image.py)
![Median of a triangle image](Images/S05/08_Median_of_a_triangle.png)
...
[Centroid of a triangle image code](Programs/S05/09_Centroid_of_a_triangle_image.py)
[Centroid of a triangle image](Images/S05/09_Centroid_of_a_triangle.png)
...
[Concurrency of the medians of a triangle theorem image code](Programs/S05/10_Concurrency_of_the_medians_of_a_triangle_theorem_image.py)
[Concurrency of the medians of a triangle theorem image](Images/S05/10_Concurrency_of_the_medians_of_a_triangle_theorem.png)
...
[Altitude of a triangle image code](Programs/S05/11_Altitude_of_a_triangle_image.py)
![Altitude of a triangle image](Images/S05/11_Altitude_of_a_triangle.png)
...
[Orthocenter of a triangle image code](Programs/S05/12_Orthocenter_of_a_triangle_image.py)
![Orthocenter of a triangle image](Images/S05/12_Orthocenter_of_a_triangle.png)
...
[Triangle longer side theorem image code](Programs/S05/13_Triangle_longer_side_theorem_image.py)
![Triangle longer side theorem image](Images/S05/13_Triangle_longer_side_theorem.png)
...
[Triangle inequality theorem image code](Programs/S05/14_Triangle_inequality_theorem_image.py)
![Triangle inequality theorem image](Images/S05/14_Triangle_inequality_theorem.png)
