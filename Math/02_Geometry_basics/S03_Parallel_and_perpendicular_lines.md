...
[Parallel lines image code](Programs/S03/01_Parallel_lines_image.py)
![Parallel lines image](Images/S03/01_Parallel_lines.png)
*Parallel lines*
...
[Skew lines image code](Programs/S03/02_Skew_lines_image.py)
![Skew lines image](Images/S03/02_Skew_lines.png)
*Skew lines*
...
[Transversal line image code](Programs/S03/03_Transversal_line_image.py)
![Transversal line image](Images/S03/03_Transversal_line.png)
*Transversal line*
...
[Transversal to parallel lines image code](Programs/S03/04_Transversal_to_parallel_lines_image.py)
![Transversal to parallel lines image](Images/S03/04_Transversal_to_parallel_lines.png)
...
[Perpendicular transversal image code](Programs/S03/05_Perpendicular_transversal_image.py)
![Perpendicular transversal image](Images/S03/05_Perpendicular_transversal.png)
...
[Values of the slope of a line image code](Programs/S03/06_Values_of_the_slope_of_a_line_image.py)
![Values of the slope of a line image](Images/S03/06_Values_of_the_slope_of_a_line.png)
...
[Slope of perpendicular lines image code](Programs/S03/07_Slope_of_perpendicular_lines_image.py)
![Slope of perpendicular lines image](Images/S03/07_Slope_of_perpendicular_lines.png)
...
![Pythagorean theorem image](../01_Algebra_basics/Images/S09/02_Pythagorean_theorem.png)
*Pythagorean theorem*
...
[Rise and run between two points image code](Programs/S03/08_Rise_and_run_between_two_points_image.py)
![Rise and run between two points image](Images/S03/08_Rise_and_run_between_two_points.png)
...
[Distance formula code](Programs/S03/09_Distance_formula.py)
...
[Shortest distance between a point and a line image code](Programs/S03/10_Shortest_distance_between_a_point_and_a_line_image.py)
![Shortest distance between a point and a line image](Images/S03/10_Shortest_distance_between_a_point_and_a_line.png)
