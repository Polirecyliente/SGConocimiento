...
# SYNTAX python3 -o1 -o2 val2
#T# this must be executed outside Python, in the operating system shell, -o1 is optional, it's the flag being turned on, the flags that modify the options of the interpreter are set before starting it, -o2 val2 is an optional kwarg pair, python3 is the Python interpreter
